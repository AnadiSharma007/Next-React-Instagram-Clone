...
function Modal() {
    ...
    const uploadPost = async () => {
        ...
        // 4) GET the download URL from fb storage and update the original post with image
  ...
  return (
    <Transition.Root show={open} as={Fragment}>
        ...
        <Dialog
        as='div'
        className='fixed z-10 inset-10 overflow-y-auto'
        onClose={setOpen}
        >
            ...
            >
                ...
                overflow-hidden shadow-xl transform transiton-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6'>
                   <div>
                        ...
                        <div>
                            <div className='mt-3 text-center sm:mt-5'>
                                <Dialog.Title
                                as='h3'
                                className="text-lg leading-6 font-medium test-gray-900"
                                >
                                    Upload a Photo
                                </Dialog.Title>
                                </div>
